<?php
/* // THIS IS TO USE PHPMAILER FILES
 ...
 */
					...
					";
/*	//	THIS TRY CATCH CODE IS TO EMAIL USERS 1
					//Load phpmailer
				    ...
				    try {
				        ...
				        $mail->setFrom('princeseanyt@gmail.com');
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('princeseanyt@gmail.com');
				       
				        //Content
				        $mail->isHTML(true);                                  
				        $mail->Subject = 'Kai likha\'san Site Sign Up';
				        $mail->Body    = $message;
 ...
 */
				        ...
				        header('location: signup.php');
/* //	THIS TRY CATCH CODE IS TO EMAIL USERS 
				    } 
				    catch (Exception $e) {
